...
public class VerbDescribe extends Verb
{
    public VerbDescribe()
    {
        super("describe,desc", "any", "as", ".*");
    }
    ...
    public void execute(ExecuteContext context)
    {
        ...
        {
            amadan.addMessage("Only the owner can change the description.");
            return;
        }
        obj.setDescription(newDesc);
        amadan.addMessage("Description changed.");
    }
}
