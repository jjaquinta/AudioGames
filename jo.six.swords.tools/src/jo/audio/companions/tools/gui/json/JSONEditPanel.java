...
public class JSONEditPanel extends JPanel {
    ...
    public JSONEditPanel() {        
        ...
        JSONJTreeNode root = new JSONJTreeNode(null, -1, null);
    ...
    public void setJsonObject(JSONObject json, UpdateType updateType) {
    ...
    public void setJson(String json, UpdateType updateType) {
        try
        {
            JSONObject jo = (JSONObject)JSONUtils.PARSER.parse(json);
            setJsonObject(jo, updateType);
        }
    ...
    public void deleteNode() {
        ...
        if(selection == null) {
            ...
            jTree.setModel(new DefaultTreeModel(new JSONJTreeNode(null, -1, null)));
        } else {
            JSONJTreeNode node = (JSONJTreeNode) selection.getLastPathComponent();
            JSONJTreeNode parent = (JSONJTreeNode) node.getParent();
            if(parent == null) {
    ...
    public JSONObject getJsonObject() {
        ...
        if(node != null)
            try
            {
                return (JSONObject)node.asJsonElement();
            }
            catch (ParseException e)
            {
                e.printStackTrace();
